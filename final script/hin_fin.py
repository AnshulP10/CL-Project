...
write1=open('hin_all.txt', 'r')
write2=open('eng_all.txt', 'r')
inp2=open('eng_fin.txt', 'r')
inp1=open('hin_fin.txt', 'r')
giza2=open('eng-hin.txt', 'r')
giza1=open('hin-eng.txt', 'r')
...
#open text files
findHE=[l2 for l2 in giza1.read().split('\n')]
findEH=[l1 for l1 in giza2.read().split('\n')]
text1=inp1.read().split('\n\n')
text2=inp2.read().split('\n\n')
hindi=write1.read().split('\n')
ans.write("Hindi Sentence:"+str(hindi[x])+'\n')
english=write2.read().split('\n')
ans.write("English Sentence:"+str(english[x])+'\n')
...
for chunk1 in sent1:
    ...
    if chunk1[3]=='N' or chunk1[3]=='V':
        head1=chunk1.split('))')[1]
        for chunk2 in sent2:
            if (chunk2[2]=='N' and chunk1[3]=='N') or (chunk2[2]=='V' and chunk1[3]=='V'):
